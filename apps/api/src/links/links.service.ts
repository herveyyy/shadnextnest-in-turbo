...
import { Link } from '@workspace/api/links/entities/link.entity';

import { CreateLinkDto } from '@workspace/api/links/dto/create-link.dto';
import { UpdateLinkDto } from '@workspace/api/links/dto/update-link.dto';
